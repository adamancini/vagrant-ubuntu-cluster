...
start:
	@vagrant up --provider libvirt haproxy ucp-1 worker-1 worker-2

full:
	@vagrant up --provider libvirt haproxy ucp-1 worker-1 worker-2 worker-3

dtr:
	@vagrant up --provider libvirt dtr-1
